...
const handleError = (errorRes: any) => {
  ...
  return of(new AuthActions.AuthenticateFail(errorMessage)); // new observable
};
...
export class AuthEffects {
      ...
      return this.http.post<AuthResponseData>(this.signUpLink,
        {
          ...
          password: signupAction.payload.pass,
      ...
      return this.http.post<AuthResponseData>(this.signInLink,
        {
          ...
          password: authData.payload.pass,
          returnSecureToken: true
        }
      ).pipe(
        tap(resData => {
  ...
  @Effect({ dispatch: false })// does not dispatch anything at the end
